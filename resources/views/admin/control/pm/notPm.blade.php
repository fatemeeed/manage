...
<title> گزارش پایانه های بازدید نشده </title>
@endsection
...
@section('content')
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> گزارش پایانه های بازدید نشده</li>
    ...
    <section class="col-12">
        ...
        <section class="main-body-container">
            ...
            <section class="main-body-container-header">
                ...
                <h5>  گزارش پایانه های بازدید نشده</h5>
                <p></p>
            ...
            <section class="mb-4">
                ...
                <form action="" method="">
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="">بازدید نشده</label>
                                <select class="form-control  form-control-sm" name="" id="">
                                    <option value="">  انتخاب کنید</option>
                                    <option value="">یک ماه بازدید نشده </option>
                                    <option value="">دو ماه بازدید نشده </option>
                                    <option value="">سه ماه بازدید نشده </option>
