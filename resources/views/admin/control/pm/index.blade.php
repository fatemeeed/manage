...
@section('content')
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page">گزارش پشتیبانی</li>
    ...
    <section class="col-12">
        ...
        <section class="main-body-container">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                ...
                                <a href="{{ route('admin.control.pm.pmDetail') }}" class="btn btn-primary btn-sm"><i class="fas fa-chart-bar"></i> به تفکیک پروژه</a>
            ...
            <section class="main-body-container-header mt-3">
                ...
                <h5> گزارش پشتیبانی به تفکیک تکنسین</h5>
                <p></p>
