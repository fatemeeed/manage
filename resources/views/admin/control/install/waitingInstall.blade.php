...
<title> گزارش پایانه های در انتظار نصب </title>
@endsection
...
@section('content')
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> گزارش پایانه های در انتظار نصب</li>
    ...
    <section class="col-12">
        ...
        <section class="main-body-container">
            ...
            <section class="main-body-container-header">
                ...
                <h5>  گزارش پایانه های در انتظار نصب</h5>
                <p></p>
