...
<title> احیا و جمع آوری پروژه بانکی</title>
@endsection
...
@section('content')
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> احیا و جمع آوری پروژه بانکی</li>
    ...
    <section class="col-12">
        ...
        <section class="main-body-container">
            ...
            <section class="main-body-container-header">
                ...
                <h5>  احیا و جمع آوری پروژه بانکی</h5>
                <p></p>
