...
<title>گزارش توقف پذیرندگان</title>
@endsection
...
@section('content')
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> گزارش توقف پذیرندگان VIP</li>
    ...
    <section class="col-12">
        ...
        <section class="main-body-container">
            ...
            <section class="main-body-container-header">
                ...
                <h5> گزارش توقف پذیرندگان VIP</h5>
                <p></p>
