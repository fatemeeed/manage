...
<title> پایانه های صفر تراکنش</title>
@endsection
...
@section('content')
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> پایانه های صفر تراکنش</li>
            ...
            <section class="mb-4">
                ...
                <form action="" method="">
                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                <label for=""> تعداد دوره</label>
                                <select class="form-control  form-control-sm" name="" id="">
                                    <option value="">تعداد دوره  را انتخاب کنید</option>
                                    <option value="">یک دوره </option>
                                    <option value="">دو دوره </option>
                                    <option value="">سه دوره </option>
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th></th>
                            <th></th>
                            <td class="width-13-rem text-left d-flex align-items-center">
